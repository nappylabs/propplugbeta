...
export const PersonaMorpher = () => {
  ...
  return (
    <div className="fixed inset-0 z-[999] flex items-center justify-center bg-zinc-900/80 backdrop-blur-xl">
      <div className="max-w-5xl w-full px-6">
        ...
        >
          ...
          <p className="text-zinc-400 text-lg">We'll tailor the dashboard to your goals.</p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {personas.map((p, i) => (
            <motion.button
              ...
              className="group relative bg-zinc-900 border border-zinc-700 hover:border-orange-500 p-8 rounded-[2.5rem] text-left transition-all hover:-translate-y-2 hover:shadow-2xl hover:shadow-orange-500/20"
            >
              <div className="w-16 h-16 bg-zinc-800 rounded-2xl flex items-center justify-center mb-6 text-zinc-400 group-hover:text-orange-400 group-hover:bg-orange-500/10 transition-colors">
                {p.icon}
              </div>
